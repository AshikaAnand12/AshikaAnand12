...
| [Yaari]() | A Whatsapp-like chat app where you can talk to friends and a journal space where you talk to yourself | FULLSTACK: Reactjs, ChakraUI, Nodejs, MongoDB, Socket.io, Context API, Cloudinary, Python, Netlify | In Construction! Be Back! |
